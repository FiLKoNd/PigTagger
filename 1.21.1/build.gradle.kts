...
base.archivesName = "PigTagger-1.21.1"
...
tasks.withType<ProcessResources> {
    ...
    inputs.property("minecraft_version", libs.versions.minecraft.mc1211.get())
    inputs.property("loader_version", libs.versions.fabric.loader.get())

    filesMatching("fabric.mod.json") {
        expand(
            "version" to project.version,
            "minecraft_version" to libs.versions.minecraft.mc1211.get(),
